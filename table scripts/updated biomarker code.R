...
mom_lab <-c("Outcome", 
            ...
            "Vitamin A Deficiency", "Low Vitamin A", "Vitamin D Deficiency", "Iron Deficiency",
            "Cortisol", "Estriol",
...
mom <-c("Median (25th, 75th percentile)", 
        ...
        nperc(d$vit_A_def), nperc(d$vit_A_low), nperc(d$vit_D_def), nperc(d$iron_def),
...
save_as_docx("Maternal Biomarkers" = flextable(mom_tbl), path=here("preg-telo maternal biomarkers table 012723.docx"), 
             pr_section = sect_properties) 

save_as_docx("Child Biomarkers" = flextable(child_tbl), path=here("preg-telo child biomarkers table 012723.docx"), 
             pr_section = sect_properties) 
